...
#define FT5206_RST_GPIO_PORT            GPIOG
#define FT5206_RST_GPIO_PIN             GPIO_PIN_3
#define FT5206_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */

#define FT5206_INT_GPIO_PORT            GPIOD
#define FT5206_INT_GPIO_PIN             GPIO_PIN_13
#define FT5206_INT_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */
