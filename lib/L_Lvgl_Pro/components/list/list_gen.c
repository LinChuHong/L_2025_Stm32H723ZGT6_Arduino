...
lv_obj_t * list_create(lv_obj_t * parent)
{
    ...
    lv_obj_t * mybutton = button_normal_create(lv_obj_0, "mybutton");
    lv_obj_set_name(mybutton, "mybutton");
    lv_obj_add_event_cb(mybutton, mycb, LV_EVENT_ALL, "ledon");
...
static lv_anim_timeline_t * timeline_list_open_create(lv_obj_t * obj)
{
    ...
    lv_obj_t * mybutton = lv_obj_find_by_name(obj, "mybutton");
    at_to_merge = button_normal_get_timeline(mybutton, BUTTON_NORMAL_TIMELINE_SHOW_UP);
    lv_anim_timeline_merge(at, at_to_merge, 400);
