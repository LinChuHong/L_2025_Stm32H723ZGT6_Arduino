...
/* TFT_SPI 相关引脚 定义 */
/* 引脚对应关系: 
 *         TFT_SPI_CS  --> TP_MISO,   TFT_SPI_SCL --> TLI_VSYNC
 *         TFT_SPI_SDA --> TLI_HSYNC, TFT_SPI_RST --> LCD_RST 
 */

#define TFT_SPI_CS_GPIO_PORT                GPIOC
#define TFT_SPI_CS_GPIO_PIN                 GPIO_PIN_4
#define TFT_SPI_CS_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */

#define TFT_SPI_SCL_GPIO_PORT               GPIOA
#define TFT_SPI_SCL_GPIO_PIN                GPIO_PIN_4
#define TFT_SPI_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define TFT_SPI_SDA_GPIO_PORT               GPIOC
#define TFT_SPI_SDA_GPIO_PIN                GPIO_PIN_6
#define TFT_SPI_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */

#define TFT_SPI_RST_GPIO_PORT               GPIOB
#define TFT_SPI_RST_GPIO_PIN                GPIO_PIN_2
#define TFT_SPI_RST_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */
