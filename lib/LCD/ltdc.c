...
uint16_t ltdc_panelid_read(void)
{
    ...
    gpio_init_struct.Pin = GPIO_PIN_9;                         /* B7引脚PB9 */
    gpio_init_struct.Mode = GPIO_MODE_INPUT;                   /* 输入 */
    gpio_init_struct.Pull = GPIO_PULLUP;                       /* 上拉 */
    gpio_init_struct.Speed = GPIO_SPEED_HIGH;                  /* 高速 */
    HAL_GPIO_Init(GPIOB, &gpio_init_struct);                   /* 初始化PB9 */
    
    gpio_init_struct.Pin = GPIO_PIN_3;                         /* G7引脚PD3 */
    HAL_GPIO_Init(GPIOD, &gpio_init_struct);                   /* 初始化PD3 */
    ...
    idx |= (uint8_t)HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_3) << 1;  /* 读取M1 */
    idx |= (uint8_t)HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_9) << 2;  /* 读取M2 */
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
    ...
    /* LTDC信号控制引脚 LTDC_DE(PC5), LTDC_VSYNC(PA4), LTDC_HSYNC(PC6), LTDC_CLK(PG7) */
    /* LTDC 数据引脚    LTDC_R7(PG6), LTDC_R6(PA8), LTDC_R5(PC0), LTDC_R4(PA5), LTDC_R3(PA15), LTDC_R2(PA1), LTDC_R1(PA2), LTDC_R0(PG13),
                       LTDC_G7(PD3), LTDC_G6(PC7), LTDC_G5(PB11), LTDC_G4(PB10), LTDC_G3(PG10), LTDC_G2(PA6), LTDC_G1(PE6), LTDC_G0(PE5),
                       LTDC_B7(PB9), LTDC_B6(PB8), LTDC_B5(PB5), LTDC_B4(PG12), LTDC_B3(PG11), LTDC_B2(PD6), LTDC_B1(PA10 不配置，默认拉高), LTDC_B0(PE4) */
    ...
    /* 初始化PA1,2,5,6,8 */
    gpio_init_struct.Pin = GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_8;
    gpio_init_struct.Alternate = GPIO_AF14_LTDC; /* 复用为LTDC */
    HAL_GPIO_Init(GPIOA, &gpio_init_struct);

    /* 初始化PA15 */
    gpio_init_struct.Pin = GPIO_PIN_15;
    gpio_init_struct.Alternate = GPIO_AF9_LTDC;  /* 复用为LTDC */
    HAL_GPIO_Init(GPIOA, &gpio_init_struct);

    /* 初始化PB5 */
    gpio_init_struct.Pin = GPIO_PIN_5;
    gpio_init_struct.Alternate = GPIO_AF3_LTDC;  /* 复用为LTDC */
    ...
    /* 初始化PC0,7 */
    gpio_init_struct.Pin = GPIO_PIN_0 | GPIO_PIN_7;
    ...
    /* 初始化PE4,5,6 */
    gpio_init_struct.Pin = GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6; 
    HAL_GPIO_Init(GPIOE, &gpio_init_struct);
    
    /* 初始化PG6,11,13 */
    gpio_init_struct.Pin = GPIO_PIN_6 | GPIO_PIN_11 | GPIO_PIN_13; 
