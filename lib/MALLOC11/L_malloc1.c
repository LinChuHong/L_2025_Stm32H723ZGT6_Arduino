...
// static __align(64) uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((at(0x20000000)));     /* 内部DTCM内存池 */
// static __align(64) uint8_t mem4base[MEM4_MAX_SIZE] __attribute__((at(0x00000000)));     /* 内部ITCM内存池 */
...
/* SDRAM pool (after first 4MB used for LCD) */
__attribute__((section(".sdram")))
static __attribute__((aligned(64)))
uint8_t mem2base[MEM2_MAX_SIZE];

/* DTCM RAM */
__attribute__((section(".dtcm")))
static __attribute__((aligned(64)))
uint8_t mem3base[MEM3_MAX_SIZE];

/* ITCM RAM */
__attribute__((section(".itcm")))
static __attribute__((aligned(64)))
uint8_t mem4base[MEM4_MAX_SIZE];
...
// static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((at(0x20000000 + MEM3_MAX_SIZE)));  /* 内部DTCM内存池MAP */
// static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE] __attribute__((at(0x00000000 + MEM4_MAX_SIZE)));  /* 内部ITCM内存池MAP */
...
__attribute__((section(".itcm")))
static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE];
...
// static uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((aligned(64))); /* 外部SDRAM内存池,地址由链接脚本决定 */
// static uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((aligned(64))); /* 内部DTCM内存池 */
// static uint8_t mem4base[MEM4_MAX_SIZE] __attribute__((aligned(64))); /* 内部ITCM内存池 */

// /* 内存管理表 */
// static MT_TYPE mem1mapbase[MEM1_ALLOC_TABLE_SIZE];                                                  /* 内部SRAM内存池MAP */
// static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE]; /* 外部SDRAM内存池MAP */
// static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE]; /* 内部DTCM内存池MAP */
// static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE]; /* 内部ITCM内存池MAP */
...
static __ALIGNED(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((section(".bss.ARM.__at_0XC03E8000")));  /* 外部SDRAM内存池 */
static __ALIGNED(64) uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((section(".bss.ARM.__at_0x20000000")));  /* 内部DTCM内存池 */
static __ALIGNED(64) uint8_t mem4base[MEM4_MAX_SIZE] __attribute__((section(".bss.ARM.__at_0x00000000")));  /* 内部ITCM内存池 */

/* 内存管理表 */
static MT_TYPE mem1mapbase[MEM1_ALLOC_TABLE_SIZE];                                                          /* 内部SRAM内存池MAP */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0XC1E30000")));     /* 外部SDRAM内存池MAP */
static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0X2001E000")));     /* 内部DTCM内存池MAP */
static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0X0000F000")));     /* 内部ITCM内存池MAP */
