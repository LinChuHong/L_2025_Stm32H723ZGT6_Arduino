...
#define CT_IIC_SCL_GPIO_PORT            GPIOD
#define CT_IIC_SCL_GPIO_PIN             GPIO_PIN_12
#define CT_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */

#define CT_IIC_SDA_GPIO_PORT            GPIOD
#define CT_IIC_SDA_GPIO_PIN             GPIO_PIN_11
#define CT_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */
