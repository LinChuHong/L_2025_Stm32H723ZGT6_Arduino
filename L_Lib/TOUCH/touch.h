...
#define T_PEN_GPIO_PIN                  GPIO_PIN_13
#define T_PEN_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
...
#define T_MISO_GPIO_PIN                 GPIO_PIN_4
...
#define T_MOSI_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define T_CLK_GPIO_PORT                 GPIOD
#define T_CLK_GPIO_PIN                  GPIO_PIN_12
#define T_CLK_GPIO_CLK_ENABLE()         do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
