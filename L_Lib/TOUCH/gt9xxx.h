...
#define GT9XXX_INT_GPIO_PORT            GPIOD
#define GT9XXX_INT_GPIO_PIN             GPIO_PIN_13
#define GT9XXX_INT_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */
