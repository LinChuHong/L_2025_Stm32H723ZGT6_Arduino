...
#define LTDC_DE_GPIO_PORT               GPIOC
#define LTDC_DE_GPIO_PIN                GPIO_PIN_5
#define LTDC_DE_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define LTDC_VSYNC_GPIO_PORT            GPIOA
#define LTDC_VSYNC_GPIO_PIN             GPIO_PIN_4
#define LTDC_VSYNC_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define LTDC_HSYNC_GPIO_PORT            GPIOC
#define LTDC_HSYNC_GPIO_PIN             GPIO_PIN_6
#define LTDC_HSYNC_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
...
#define LTDC_BL_GPIO_PIN                GPIO_PIN_14
#define LTDC_BL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */

#define LTDC_RST_GPIO_PORT              GPIOB
#define LTDC_RST_GPIO_PIN               GPIO_PIN_2
#define LTDC_RST_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
