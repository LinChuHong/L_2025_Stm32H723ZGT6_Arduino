...
/* 用户配置区
 * SDMMC时钟计算公式: SDMMC_CK时钟 = sdmmc_ker_ck / [2 * clkdiv]; 其中,sdmmc_ker_ck默认选择来自pll1_q_ck,为260Mhz
 * 注意：SDMMC_INIT_CLK_DIV 在HAL库有定义，我们只要把它的值改为325,即(0x145),请到stm32h7xx_ll_sdmmc.h修改。
 */
//#define SDMMC_INIT_CLK_DIV        325       /* SDMMC初始化频率，260M / (325 * 2) = 400Khz,最大400Kh */
