...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 188, 177);
    lv_obj_set_size(ui->screen_1_btn_1, 595, 202);
    ui->screen_1_btn_1_label = lv_label_create(ui->screen_1_btn_1);
    lv_label_set_text(ui->screen_1_btn_1_label, "To Main Screen");
    lv_label_set_long_mode(ui->screen_1_btn_1_label, LV_LABEL_LONG_SCROLL);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_1, lv_color_hex(0x2FDAAE), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_1, &lv_font_FontAwesome5_86, LV_PART_MAIN|LV_STATE_DEFAULT);
